    ...
    <div className="min-h-[80vh] flex items-center justify-center">
      <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-200 w-full max-w-md">
        ...
        <button
          ...
          disabled={loading || googleLoading}
          className="w-full py-2 px-4 bg-white text-gray-700 font-medium rounded-lg border border-gray-300 hover:bg-gray-50 disabled:opacity-50 flex items-center justify-center gap-3"
        >
          ...
          {googleLoading ? '連接 Google 中...' : '使用 Google 登入'}
        </button>
